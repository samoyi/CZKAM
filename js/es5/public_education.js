...
vCatalog.catas = [[{ title_c: "公教活动" }, { title_e: "ACTIVITIES" }, { cata_c: ["山水高研班", "艺术大讲堂"] }, { cata_e: ["ADVANCED SEMINAR", "ART FORUM"] }, 0], [{ title_c: "合作交流" }, { title_e: "FACILITIES" }, { cata_c: [] }, { cata_e: [] }, 1, "none"], [{ title_c: "志愿者服务" }, { title_e: "VOLUNTEERING" }, { cata_c: [] }, { cata_e: [] }, 2]];
...
window.onload = function () {
    ...
    // 艺术大讲堂数据
    {
        var _sURL = "ajax.php?item=public_ysdjt",
    ...
    // 志愿者服务数据
    {
        var _sURL2 = "ajax.php?item=public_volunteering",
