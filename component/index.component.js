...
let vContent = new Vue({
    ...
    computed: {
        ...
        exhibitionGetTab(){
            if( this.exhibitionTabs.length ){
                return this.exhibitionTabs[this.exhibitionIndex];
            }
            else{
                return [,,,];
            }
        },
        publicEducationGetTab(){
            if( this.publicEducationTabs.length ){
                return this.publicEducationTabs[this.publicEducationIndex];
            }
            else{
                return [,,];
            }
...
// 轮播
setInterval(function(){
    vContent.exhibitionIndex = (vContent.exhibitionIndex+1) % 3;
}, 1000);

vContent.publicEducationTabs = [
