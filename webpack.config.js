    ...
    contents.forEach(item=>{
        if(fs.statSync(sPagesDir+item).isDirectory()){
            ...
            aHWP.push(new HtmlWebpackPlugin({
                ...
                chunks: [item],
                outerCSS: `
                    <link href="http://funca.oss-cn-hangzhou.aliyuncs.com/CuiZhenkuanArtMuseum/css/common20170803.css" type="text/css" rel="stylesheet">
                    <link href="http://funca.oss-cn-hangzhou.aliyuncs.com/CuiZhenkuanArtMuseum/css/index20170803.css" type="text/css" rel="stylesheet">
                    <link rel="stylesheet" href="https://cdn.bootcss.com/Swiper/3.4.2/css/swiper.min.css">
                `,
                outerJS: `
                    <script src="https://cdn.bootcss.com/vue/2.4.2/vue.min.js"></script>
                    <script src="https://cdn.bootcss.com/Swiper/3.4.2/js/swiper.min.js"></script>
                    <script src="component/index.component.js"></script>
                    `
            }));
        }
    });
